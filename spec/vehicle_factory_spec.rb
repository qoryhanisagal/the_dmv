...
RSpec.describe VehicleFactory do
  before(:each) do
    @factory = VehicleFactory.new  # Initialize the VehicleFactory instance before each test

    # Sample data from external dataset (this is a simplified version of what you'd get from the API)
    @vehicle_data = [
      {
        vin_1_10: 'JTDKN3DP8D',
        model_year: '2013',
